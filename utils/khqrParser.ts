...
export const BANK_THEMES: Record<string, BankTheme> = {
  "ABA Bank": {
    primaryColor: "#005696",
    badgeBg: "bg-blue-600/20 border-blue-500/40",
...
export function parseKhqrData(qrText: string): KhqrParseResult {
  ...
  if (merchantBlock) {
    ...
    const city = rootData["60"] || undefined;
    const country = rootData["58"] || undefined;
...
// Sample test KHQR data so users can test immediately
export interface SampleKhqr {
  id: string;
  title: string;
  bankName: string;
  accountName: string;
...
export const SAMPLE_KHQRS: SampleKhqr[] = [
  {
    id: 'aba_sample',
    title: 'ABA Bank - គណនីបុគ្គល',
    bankName: 'ABA Bank',
    accountName: 'SOK SAMNANG',
    accountNumber: '001928374',
    amount: '15.50',
    currency: 'USD',
    rawQr: '00020101021229380014soksamnang@abaa01090019283740203USD520459995303840540515.505802KH5911SOK SAMNANG6010PHNOM PENH62150111ABA PAYMENT63048E12'
  },
  {
    id: 'acleda_sample',
    title: 'ACLEDA Bank - ហាងទំនិញ',
    bankName: 'ACLEDA Bank',
    accountName: 'CHEA RATANA COFFEE',
    accountNumber: '0967956983',
    amount: '2.75',
    currency: 'USD',
    rawQr: '000201010211304500160967956983@aclb0111855299122930208ACLEDA0052045499530384054042.755802KH5919CHEA RATANA COFFEE6010PHNOM PENH62170210096795698363044C9A'
  },
  {
    id: 'wing_sample',
    title: 'Wing Bank - គណនីអាជីវកម្ម',
    bankName: 'Wing Bank',
    accountName: 'KONG SOPHEA EXPRESS',
    accountNumber: '100467375',
    amount: '20000',
    currency: 'KHR',
    rawQr: '00020101021229340012sophea@wing01091004673750203KHR5204599953031165405200005802KH5919KONG SOPHEA EXPRESS6010PHNOM PENH6304E8A1'
  },
  {
    id: 'canadia_sample',
    title: 'Canadia Bank - គណនីទូទៅ',
    bankName: 'Canadia Bank',
    accountName: 'HENG CHHAY LEANG',
    accountNumber: '012889900',
    amount: '50.00',
    currency: 'USD',
    rawQr: '00020101021229330011chhay@cnba01090128899000203USD520459995303840540550.005802KH5916HENG CHHAY LEANG6010PHNOM PENH63049F2D'
  }
];
